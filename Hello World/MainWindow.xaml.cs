...
namespace Hello_World
{
    public partial class MainWindow : Window
    {
            ...
            try
            {
                ...
                if (userInput != null)
                {
                    ...
                    ContentDialog dialog = new ContentDialog
                    {
                        ...
                        Content = $"Behold! Your fortune has become clear. With the power of your magic number, I see your future. You'll have an amazing carrer in {result[4]}, you'll live in a/an {result[0]}, marry {result[1]}, have {result[2]} child(ren) with them and drive a {result[3]}.",
                        CloseButtonText = "OK",
        ...
        private async Task<AISuggestions> GetAISuggestions(UserInput userInput)
        {
            ...
            string careerInputText = $"We are going to play a game, a very silly game. The one rule is that you can only provide a single response that is 3 words or less. I'll give you two carrer or jobs and I want you to tell me a, only one, career or job and nothing else. Ideally something that would be funny or odd for the first two. Let's begin now: {userInput.Career1} and {userInput.Career2}";
